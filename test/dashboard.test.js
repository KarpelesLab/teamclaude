...
// The page's main inline script — what the CSP hashes and what the harness
// below runs. One extraction for every test, so a page that gains a second
// script block changes this in one place.
