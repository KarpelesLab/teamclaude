...
async function serverCommand() {
  ...
  let tui = null;
  // A bag of optional callbacks the proxy reaches for by name, filled in below
  // and in the TUI branch. `Object` described it no better than the empty
  // literal does, and made every assignment to it a type error.
